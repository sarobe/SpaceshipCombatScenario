...
public class SingleMCTSPlayer implements Player
{
    ...
    public SingleMCTSPlayer(TreePolicy a_treePolicy, Heuristic a_h, Random a_rnd, IGameState a_game, PlayoutInfo pInfo)
    {
        m_playoutInfo = pInfo;
    ...
    public int run(IGameState a_gameState, long a_timeDue, boolean a)
    {
    ...
    public PlayoutInfo getPlayoutInfo(){return m_playoutInfo;}

...
public class SingleMCTSController extends Controller
{
     ...
     * Current game state
     */
    public static IGameState m_currentGameState;


    public static HeuristicPickup m_heuristic;

    /**
     * Constructor of the controller
     * @param a_game Copy of the initial game state.
     */
    public SingleMCTSController(IGameState a_game)
    {
        ...
        m_heuristic = new HeuristicPickup();
        m_player = new SingleMCTSPlayer(new SingleTreePolicy(SingleMCTSParameters.K), m_heuristic, m_rnd, a_game, new PlayoutPickupInfo());
     ...
     */
    public int getAction(IGameState a_game, long a_timeDue)
    {
        FLAG = false;
        HV_COUNTS = 0;
     ...
     */
    public void prepareGameCopy(IGameState a_game)
    {

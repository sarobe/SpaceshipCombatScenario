...
public abstract class Controller implements Runnable
{
     ...
     */
    public final synchronized void update(IGameState a_game,long a_timeDue)
    {
     ...
     */
    public abstract int getAction(IGameState a_game, long a_timeDue);
